            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-content m-b-40">
                        <h5 class="section-content__title text-center">Еще нет аккаунта?Зарегестрируйтесь прямо сейчас!</h5>
                    </div>
                </div>
                <!-- Start Login Area -->
...
{{--                </div>--}}
                <div class="col-6">
                    <div class="login-form-container">
                        <h5 class="sidebar__title">Регистрация</h5>
                        <div class="login-register-form">
                            <form action="{{route('register')}}" method="post">
                                @csrf
                                <div class="form-box__single-group">
                                    <label for="form-register-username">Логин *</label>
                                    <input type="name" id="form-register-username" placeholder="Username" required>
                                </div>
                                <div class="form-box__single-group">
                                    <label for="form-uregister-sername-email">Email адрес *</label>
                                    <input type="email" id="form-uregister-sername-email" placeholder="Enter email" required>
                                </div>
                                <div class="form-box__single-group m-b-20">
                                    <label for="form-register-username-password">Пароль *</label>
                                    <div class="password__toggle">
                                ...
                                <button class="btn btn--box btn--medium btn--radius btn--black btn--black-hover-green btn--uppercase font--semi-bold" type="submit">Зарегистрироваться</button>
                            </form>
                        </div>
                    </div>
                </div>  <!-- End Login Area -->

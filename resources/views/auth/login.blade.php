            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-content m-b-40">
                        <h5 class="section-content__title text-center">Вход в аккаунт</h5>
                    </div>
                </div>
                <!-- Start Login Area -->
                <div class="col-6">
                    <div class="login-form-container">
                        <h5 class="sidebar__title">Авторизация</h5>
                        <div class="login-register-form">
                            <form action="{{route('login')}}" method="post">
                                @csrf
                                <div class="form-box__single-group">
                                    <label for="form-username">Email</label>
                                    <input type="text" id="form-username" placeholder="Введите email" required>
                                </div>
                                <div class="form-box__single-group m-b-20">
                                    <label for="form-username-password">Пароль *</label>
                                    <div class="password__toggle">
                                        <input type="password" id="form-username-password" placeholder="Введите пароль" required>
...
{{--                                </div>--}}
                                <button class="pt-3 btn btn--box btn--medium btn--radius btn--black btn--black-hover-green btn--uppercase font--semi-bold" type="submit">Вход</button>
                            </form>
                        </div>
                    </div>
                </div>

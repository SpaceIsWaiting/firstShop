                        ...
                        <div class="product-details-box m-b-60">
                            ...
                            <div class="product__price m-t-5">
                                @if($product->new_price!=null)
                                    <span class="product__price product__price--large">{{$product->new_price}}Р <del>{{$product->price}}Р</del></span>
                                    <span
                                        class="product__tag m-l-15 btn--tiny btn--green">{{$product->discount($product->price,$product->new_price)}}</span>
                                @else
                                @endif
                            </div>
                            ...
                            <div class="product-var p-tb-30">
                                ...
                                <div class="product-var__item">
                                    <a href="#modalAddCart" data-toggle="modal" data-dismiss="modal"
                                       class="btn btn--long btn--radius-tiny btn--green btn--green-hover-black btn--uppercase btn--weight m-r-20">Добавить
                                        в корзину</a>
                                ...
                                <div class="product-var__item">
                                    <div class="dynmiac_checkout--button">
                                        ...
                                        <label for="buy-now-check" class="m-b-20">I agree with the terms and
                                            condition</label>
                                        <a href="cart.html"
                                           class="btn btn--block btn--long btn--radius-tiny btn--green btn--green-hover-black text-uppercase m-r-35">Купить
                                            прямо сейчас</a>
                                    </div>
                                </div>
                                <div class="product-var__item">
                    ...
                    <div class="col-12">
                        <div class="product-details-content">
                            <ul class="tablist tablist--style-black tablist--style-title tablist--style-gap-30 nav">
                                <li><a class="nav-link active" data-toggle="tab" href="#product-desc">Description</a>
                                </li>
                                            ...
                                            <div class="table-responsive-md">
                                                <table class="product-dis__list table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="product-dis__text">American heirloom jean shorts pug
                                                            seitan letterpress
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                    ...
                                    <div class="tab-pane " id="product-review">
                                                        ...
                                                        <div class="comment__wrapper">
                                                            ...
                                                            <div class="comment__content">
                                                                <div class="comment__content-top">
                                                                    ...
                                                                    <div class="comment__content-right">
                                                                        <a href="#"
                                                                           class="link--gray link--icon-left m-b-5"><i
                                                                                class="fas fa-reply"></i>Reply</a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="para__content">
                                                                    <p class="para__text">Lorem ipsum dolor sit amet,
                                                                        ...
                                                                        aliquam, voluptatem maiores animi dolor nulla
                                                                        magnam ea! Dignissimos aspernatur cumque nam
                                                                        quod sint provident modi alias culpa, inventore
                                        ...
                                        <div class="review-form m-t-40">
                                            <div class="section-content">
                                                ...
                                                <p class="section-content__desc">Your email address will not be
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-box__single-group">
                                                            ...
                                                            <textarea id="form-review" rows="8"
                            ...
                            <div class="product-default-slider-4grid-1rows gap__col--30 gap__row--40">
                                ...
                                <div class="product__box product__default--single text-center">
                                    ...
                                    <div class="product__content m-t-20">
                                        ...
                                        <a href="product-single-default.html" class="product__link">Fresh green
                                            vegetable</a>
                                        <div class="product__price m-t-5">
                                ...
                                <div class="product__box product__default--single text-center">
                                    ...
                                    <div class="product__content m-t-20">
                                        ...
                                        <a href="product-single-default.html" class="product__link">Fresh
                                            pomegranate</a>
                                        <div class="product__price m-t-5">
                                ...
                                <div class="product__box product__default--single text-center">
                                    ...
                                    <div class="product__content m-t-20">
                                        ...
                                        <a href="product-single-default.html" class="product__link">Cabbage
                                            vegetables</a>
                                        <div class="product__price m-t-5">
                                ...
                                <div class="product__box product__default--single text-center">
                                    ...
                                    <div class="product__content m-t-20">
                                        ...
                                        <a href="product-single-default.html" class="product__link">Juice fresh
                                            orange</a>
                                        <div class="product__price m-t-5">
                                            <span class="product__price">$19.00 <del>$29.00</del></span>
                                        </div>

                    ...
                    <div class="col-md-5">
                        <div class="product-gallery-box product-gallery-box--default m-b-60">
                            <div class="product-image--large product-image--large-horizontal">
                                <img class="img-fluid" id="img-zoom" src="/images/{{$product->images[0]['img']}}" data-zoom-image="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg" alt="">
                            </div>
                            <div id="gallery-zoom" class="product-image--thumb product-image--thumb-horizontal pos-relative">
                                <a class="zoom-active" data-image="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg" data-zoom-image="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg">
                                    <img class="img-fluid" src="/images/{{$product->images[0]['img']}}" alt="">
                                </a>
                        ...
                        <div class="product-details-box m-b-60">
                            ...
                            <div class="product__price m-t-5">
                                @if($product->new_price!=null)
                                    ...
                                    <span class="product__tag m-l-15 btn--tiny btn--green">{{$product->discount($product->price,$product->new_price)}}</span>
                                @else
                                @endif
                            </div>
...
{{--                                </div>--}}
                                ...
                                <div class="product-var__item">
                                    <a href="#modalAddCart" data-toggle="modal" data-dismiss="modal" class="btn btn--long btn--radius-tiny btn--green btn--green-hover-black btn--uppercase btn--weight m-r-20">Добавить в корзину</a>
{{--                                    <a href="wishlist.html" class="btn btn--round btn--round-size-small btn--green btn--green-hover-black"><i class="fas fa-heart"></i></a>--}}
                                ...
                                <div class="product-var__item">
                                    <div class="dynmiac_checkout--button">
                                        ...
                                        <a href="cart.html" class="btn btn--block btn--long btn--radius-tiny btn--green btn--green-hover-black text-uppercase m-r-35">Купить прямо сейчас</a>
                                    </div>
                                </div>
                                <div class="product-var__item">

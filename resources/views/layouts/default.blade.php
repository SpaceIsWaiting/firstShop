                    ...
                    <div class="col-12">
                        <div class="header__top-content d-flex justify-content-between align-items-center">
                            <div class="header__top-content--left">
                                <span>Наш Интернет-магазин обладает всеми необходимыми медицинскими товарами</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row ">
                    <div class="col-12  d-flex justify-content-between align-items-center">
                        ...
                        <div class="header__logo">
                            <a href="{{route('home')}}" class="header__logo-link img-responsive">
                        ...
                        <div class="header-menu ">
                            <nav>
                                <ul class="header__nav">
                                    ...
                                    <!--Start Single Nav link-->
                                    <li class="header__nav-item pos-relative">
                                        <a href="#" class="header__nav-link">Магазин <i class="fal fa-chevron-down"></i></a>
...
{{--                                            </li>--}}
                                    ...
                                    <!--Start Single Nav link-->
                                    <li class="header__nav-item pos-relative">
                                        <a href="{{route('help')}}" class="header__nav-link">Помощь</a>
                                    </li>
                                </ul>
                        </nav>
                        </div> <!-- End Header Menu -->
                        <!-- Start Wishlist-AddCart -->
                            ...
                            <ul class="nav-bar-nav header__user-action-icon">
                                ...
                                </linav-item> <!-- End Header Add Cart Box -->
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-xl-3 col-lg-3">
                        <div class="header-menu-vertical pos-relative">
                            <h4 class="menu-title link--icon-left"><i class="far fa-align-left"></i>Категории</h4>
                            <ul class="menu-content pos-absolute">
                                <li class="menu-item"><a href="#">Акции и скидки</a></li>
                                <li class="menu-item"><a href="#">Помощь</a></li>
                                <li class="menu-item"><a href="#">Адрес магазина</a></li>
                                <li class="menu-item"><a href="#"> Доставка</a></li>
                                <li class="menu-item"><a href="#"> Возврат средств</a></li>
{{--                                <li class="menu-item"><a href="#"> Возврат средств</a></li>--}}
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-6">
                        <form class="header-search" action="#" method="post">
                            <div class="header-search__content pos-relative">
                                <input type="search" name="header-search" placeholder="Что-то хотите найти?" required>
                                <button class="pos-absolute" type="submit"><i class="icon-search"></i></button>
                            </div>
                        </form>
                    </div>
                    <div class="col-xl-2 col-lg-3">
                        <div class="header-phone text-left"><span>Появились вопросы?</span></div>
                        <div class="header-phone text-left"><span>+8 962 913 49 82</span></div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="header__mobile--leftside d-flex align-items-center justify-content-start">
                        <li>
                            <div class="header__mobile-logo">
                                <a href="{{route('home')}}" class="header__mobile-logo-link">
                ...
                <div class="col-lg-4 col-md-5">
                    <div class="footer__about">
                        ...
                        <ul class="footer__address">
                            <li class="footer__address-item"><i class="fa fa-home"></i>N221b, Baker street</li>
                            <li class="footer__address-item"><i class="fa fa-phone-alt"></i>+8 962 913 49 82</li>
                            <li class="footer__address-item"><i class="fa fa-envelope"></i>example@mail.ru</li>
                        </ul>
